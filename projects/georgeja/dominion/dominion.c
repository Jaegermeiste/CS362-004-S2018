...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
	case adventurer:
		return cardEffectAdventurer(currentPlayer, state);				// JG refactor
	...
	case mine:
		return cardEffectMine(currentPlayer, state, handPos, choice1, choice2);	// JG refactor

	case remodel:
		return cardEffectRemodel(currentPlayer, state, handPos, choice1, choice2);	// JG refactor

	case smithy:
		return cardEffectSmithy(currentPlayer, state, handPos);	// JG refactor
	...
	case sea_hag:
		return cardEffectSeaHag(currentPlayer, state);
